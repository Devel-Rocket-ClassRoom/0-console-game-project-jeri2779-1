...
namespace Framework.Engine
{
    public static class Input
    {
        ...
        private static extern short GetAsyncKeyState(int vKey);// 키 상태 가져오기

        private static readonly HashSet<ConsoleKey> s_currentKeys = new(); // 현재 프레임에 눌려있는 키
        private static readonly HashSet<ConsoleKey> s_previousKeys = new();// 이전 프레임에 눌려있던 키
